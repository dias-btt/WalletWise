...
extension AppMetadataQueryWhere
  ...
  QueryBuilder<AppMetadata, AppMetadata, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppMetadata, AppMetadata, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension AppMetadataQueryProperty
  ...
  QueryBuilder<AppMetadata, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
